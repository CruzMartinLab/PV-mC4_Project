function [reset_thresh_data] = reset_V_and_thresh_finder_FIRST_SPIKE(spiking_files, spiking_injcur, num_spike_sweeps)
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%          v_threshold snd resrt for first spike                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%Initial set up of a cell array
reset_thresh_data = cell(length(spiking_injcur)+2,(length(spiking_files)*5)+3);
reset_thresh_data(2,1) = {'Injected Current'};

reset_thresh_data(2,2:5:end) = {'Basline (mV)'};
reset_thresh_data(2,3:5:end) = {'Reset (mV)'};
reset_thresh_data(2,4:5:end) = {'Reset delta (mV)'};
reset_thresh_data(2,5:5:end) = {'Threshold (mV)'};
reset_thresh_data(2,6:5:end) = {'Threshold delta (mV)'};
...
%         figure; plot(d_mV(:,iii))
%         hold on
%         plot(inflection_holder(1,1), inflection_holder(1,2), 'r*')
%         hold on
%         plot(minima_idx(1), minima_mV(1), 'r*')
%         hold on
%         yline(d_mV_bl)
        
            reset_thresh_data(iii+2,fill_col) = {d_mV_bl};
            reset_thresh_data(iii+2,fill_col+1) = {minima_mV(1)};
            reset_thresh_data(iii+2,fill_col+2) = {minima_mV(1) - d_mV_bl};
            reset_thresh_data(iii+2,fill_col+3) = {inflection_holder(1,2)};
            reset_thresh_data(iii+2,fill_col+4) = {inflection_holder(1,2) - d_mV_bl}; 
        else
...
all_reset_deltas = nanmean(cell2mat(reset_thresh_data(3:end, 4:5:end)),2);
all_thresh_deltas = nanmean(cell2mat(reset_thresh_data(3:end, 6:5:end)),2);
...
basefilename = strcat(path_parts1(7), '_', path_parts1(8), '_', path_parts1(9), '_FIRST_SPIKE_reset_thresh_data.xlsx');
