...
%     load(fullfile(logs(i).folder,'TimeStamp.mat'));
  ...
  final_results(i+1,18)=cellstr(genotype);
  final_results(i+1,19)=cellstr(sex);
    ...
    for j=2:m
     ...
     %end
      ...
      if hasFrame(oldv)
            ...
            for j=1:4
                y=round(frame_cor(j,1));
                x=round(frame_cor(j,2));
            ...
            if interactions{j,2}==1
                if contains(trial,'T4')
                y=round((nov(1)+nov(3))/2);
                x=round((nov(2)+nov(4))/2);
                frame((x-5):(x+5),(y-5):(y+5),1) = 250;
                frame((x-5):(x+5),(y-5):(y+5),2) = 250;
                frame((x-5):(x+5),(y-5):(y+5),3) = 250;
                else
                y=round((obj1(1)+obj1(3))/2);
                x=round((obj1(2)+obj1(4))/2);
                frame((x-5):(x+5),(y-5):(y+5),1) = 250;
                frame((x-5):(x+5),(y-5):(y+5),2) = 250;
                frame((x-5):(x+5),(y-5):(y+5),3) = 250;
                end
            ...
            if interactions{j,3}==1                               
                y=round((obj2(1)+obj2(3))/2);
                x=round((obj2(2)+obj2(4))/2);
                frame((x-5):(x+5),(y-5):(y+5),1) = 250;
                frame((x-5):(x+5),(y-5):(y+5),2) = 250;
                frame((x-5):(x+5),(y-5):(y+5),3) = 250;               
            end
